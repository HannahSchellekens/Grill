...
fun MutableMatrix<Int>.addRowIntModify(rowIndex: Int, rowToAddIndex: Int, scalar: Int = 1): MutableMatrix<Int> {
    for (col in columnIndices) {
...
fun Matrix<Int>.addRowInt(rowIndex: Int, rowToAddIndex: Int, scalar: Int = 1): Matrix<Int> {
    return toMatrix().addRowIntModify(rowIndex, rowToAddIndex, scalar)
}
...
fun MutableMatrix<Double>.addRowModify(rowIndex: Int, rowToAddIndex: Int, scalar: Double = 1.0): MutableMatrix<Double> {
    for (col in columnIndices) {
        this[rowIndex, col] = this[rowIndex, col] + scalar * this[rowToAddIndex, col]
    }
    return this
...
fun Matrix<Double>.addRow(rowIndex: Int, rowToAddIndex: Int, scalar: Double = 1.0): Matrix<Double> {
    return toMatrix().addRowModify(rowIndex, rowToAddIndex, scalar)
}